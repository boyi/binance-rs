...
impl Savings {
    ...
    pub async fn get_all_coins(&self) -> Result<Vec<CoinInfo>, BinanceError> {
    ...
    pub async fn asset_detail(&self, asset: Option<String>) -> Result<BTreeMap<String, AssetDetail>, BinanceError> {
    ...
    pub async fn deposit_address<S>(&self, coin: S, network: Option<String>) -> Result<DepositAddress, BinanceError>
    where
        S: Into<String>,
    {
        let mut parameters = BTreeMap::new();
